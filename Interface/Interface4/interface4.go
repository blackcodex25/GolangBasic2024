...
func main() {
	...
	// ประกาศตัวแปร t ที่ชี้ไปยัง T ที่มีฟิลด์ S เป็น "hello"
	i = &T{"hello"} // กำหนด pointer ไปยัง T ให้กับ i (i = &T{"hello"})
	describe(i)     // เรียกใช้ฟังก์ชัน describe(i) เพื่อผิดรายละเอียดของ i
	i.M()           // เรียกใช้เมธอด m ของ i

}

// ฟังก์ชัน describe ใช้ fmt.Printf เพื่อพิมพ์ค่าของตัวแปร i และชนิดข้อมูลของ i
func describe(i I) {
	f.Printf("(%v, %T)\n", i, i)
